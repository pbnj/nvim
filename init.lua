...
require('lazy').setup({
  -- tpope
  { 'tpope/vim-dadbod', dependencies = {'kristijanhusak/vim-dadbod-ui'} },
  { 'tpope/vim-dotenv' },
  { 'tpope/vim-eunuch' },
  ...
  { 'tpope/vim-sleuth' },
  { 'tpope/vim-vinegar' },
  { 'numToStr/Comment.nvim', opts = {} }, -- to be deprecated once neovim 0.10 (built-in commenting support) is released. see https://github.com/neovim/neovim/pull/28176
